...
public class HoodieSparkCompactionAdminClient extends BaseCompactionAdminClient {

  private static final Logger LOG = LogManager.getLogger(HoodieSparkCompactionAdminClient.class);

  public HoodieSparkCompactionAdminClient(HoodieEngineContext context, String basePath) {
  ...
  @Override
  protected List<Pair<HoodieLogFile, HoodieLogFile>> getRenamingActionsForUnschedulingCompactionPlan(HoodieTableMetaClient metaClient, String compactionInstant, int parallelism, Option<HoodieTableFileSystemView> fsViewOpt, boolean skipValidation) throws IOException {
    JavaSparkContext jsc = HoodieSparkEngineContext.getSparkContext(context);
